 ...
 * 
 * import com.nishit.jwt.JwtAuthenticationEntryPoint; import
 * com.nishit.jwt.JwtRequestFilter;
 * 
 * @Configuration
 * 
 * @EnableWebSecurity
 ...
 * .authorizeRequests().antMatchers("/authenticate").permitAll()//swagger-ui/
 * index.html .antMatchers("/swagger-ui/index.html").permitAll(). // all other
 ...
 * ().sessionManagement()
 * .sessionCreationPolicy(SessionCreationPolicy.STATELESS); // Add a filter to
